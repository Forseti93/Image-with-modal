...
class ModalDialog extends HTMLElement {
  constructor() {
    super();
    // Use a more specific selector for the close button to avoid conflicts
    this.querySelector('button[id^="ModalClose-"]').addEventListener('click', this.hide.bind(this, false));
  ...
  show(opener) {
    ...
    // Assuming trapFocus and pauseAllMedia are globally available helper functions
  ...
  hide() {
    ...
    // Assuming removeTrapFocus is a global helper function
